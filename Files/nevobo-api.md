...
De app gebruikt de Nevobo RSS- en ICS-exportfeeds als primaire bron voor programma's en uitslagen. In deze sectie staat hoe je de verschillende feed-URL's opbouwt en welke varianten je in de backend gebruikt voor clubs en teams.
...
2.  Zo niet: `INSERT OR IGNORE INTO clubs` met naam + nevobo\_code
...
| Reistijden | `travelTimeCache` | Geen TTL | \`"fromAddr |
